...
args.data_dir='/Users/azadoks/Source/git/EE-559/practical/data/'
...
def load_data(cifar = None, one_hot_labels = False, normalize = False, flatten = True):
    ...
    if args.cifar or (cifar is not None and cifar):
        print('* Using CIFAR')
        cifar_train_set = datasets.CIFAR10(data_dir + '/cifar10/', train = True, download = False)
        cifar_test_set = datasets.CIFAR10(data_dir + '/cifar10/', train = False, download = False)
